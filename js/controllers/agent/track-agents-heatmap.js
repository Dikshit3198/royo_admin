Royo.controller('TrackAgentsHeatMapCtrl', ['$scope', '$rootScope', '$stateParams', 'API', 'services', 'factories',
        ...
        var getAgentList = function () {
            ...
            services.GET_DATA(param_data, API.GET_AGENT_LIST(), function (response) {
                if (!!response && response.data) {
                   ...
                   $scope.loc_data= getPoints(agents)
                   console.log($scope.loc_data)
    ...
    var getPoints = function(data){
        ...
        data.forEach((agent_data)=>{
            console.log(agent_data.longitude)
            if(agent_data.latitude && agent_data.longitude)
            {
                result.push(new google.maps.LatLng(agent_data.latitude,agent_data.longitude))
